...
class Dashboard extends CI_Controller
{
	...
	public function produk_add()
	{
		if ($this->input->post()) {
			...
			$this->db->insert('produk_new', $data);
			$this->session->set_flashdata('message', 'swal("Berhasil!", "Tambah produk berhasil", "success");');
	...
	{
		$this->db->delete('produk_new', ['id' => $id]);
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Hapus produk berhasil", "success");');
		redirect('dashboard/produk');
	}
